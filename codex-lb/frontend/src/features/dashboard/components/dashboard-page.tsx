...
import { LivingDashboard } from "@/features/dashboard/components/living-dashboard";
...
export function DashboardPage() {
  ...
  return (
    <div className="animate-fade-in-up space-y-8">
      ...
      {!view || !overview || !logPage ? (
        <DashboardSkeleton />
      ) : (
        <>
          <LivingDashboard overview={overview} requests={logPage.requests} />

          <div className="flex items-center gap-3 pt-2">
            <h2 className="text-[13px] font-medium uppercase tracking-wider text-muted-foreground">Codex LB details</h2>
