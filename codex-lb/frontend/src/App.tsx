...
const LocalUsagePage = lazy(() =>
  import("@/features/local-usage/components/local-usage-page").then((m) => ({ default: m.LocalUsagePage })),
);
      ...
      <AuthGate>
        <Routes>
          <Route element={<AppLayout />}>
            ...
            <Route path="/local-usage" element={<LocalUsagePage />} />
